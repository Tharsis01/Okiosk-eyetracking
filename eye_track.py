...
#             pyautogui.moveTo(i, j)
#             getEye(times = 100, coords=(i,j),counterStart=k, folder = "C:/Users/tawoo/Webcam-Eyetracking-master/mytraineyes")
for k in [0, 100, 200]:
    input("Press Enter to continue...")
    getEye(times = 100, coords=(810,1920),counterStart=k, folder = "C:/Users/tawoo/Webcam-Eyetracking-master/mytraineyes")
